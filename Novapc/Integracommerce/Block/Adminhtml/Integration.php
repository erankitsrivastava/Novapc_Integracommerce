...
class Integration extends Container
{
    /**
     * @var LayoutFactory
     */
    ...
    {
        $this->setChild('grid', $this->viewLayoutFactory->create()->createBlock('integracommerce/adminhtml_integration_grid', 'integration.grid'));
