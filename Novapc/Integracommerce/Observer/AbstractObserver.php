...
namespace Novapc\Integracommerce\Observer;
...
abstract class AbstractObserver
{
    ...
    public function stockQueue(Observer $event)
    {
    ...
    public function orderQueue(Observer $event)
    {
    ...
    public function massproductQueue(Observer $event)
    {
    ...
    public function productQueue(Observer $event)
    {
